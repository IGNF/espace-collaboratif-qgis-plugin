...
class Ui_ReplyReportView(object):
    def setupUi(self, ReplyReportView):
        ...
        self.StatutItemsSourceComboBox = QtWidgets.QComboBox(parent=ReplyReportView)
        ...
        self.btn_sendResponse = QtWidgets.QPushButton(parent=ReplyReportView)
        self.btn_sendResponse.setGeometry(QtCore.QRect(180, 290, 91, 31))
        self.btn_sendResponse.setObjectName("btn_sendResponse")
        self.lbl_newStatut = QtWidgets.QLabel(parent=ReplyReportView)
        ...
        self.lbl_response = QtWidgets.QLabel(parent=ReplyReportView)
        ...
        self.lbl_numberReportLabel = QtWidgets.QLabel(parent=ReplyReportView)
        ...
        self.pte_NewResponse = QtWidgets.QPlainTextEdit(parent=ReplyReportView)
