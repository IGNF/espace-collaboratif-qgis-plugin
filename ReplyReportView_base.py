...
class Ui_ReplyReportView(object):
    def setupUi(self, ReplyReportView):
        ...
        self.NewResponseTextBox = QtWidgets.QTextBrowser(ReplyReportView)
        self.NewResponseTextBox.setGeometry(QtCore.QRect(10, 90, 381, 151))
        self.NewResponseTextBox.setObjectName("NewResponseTextBox")
