# -*- coding: utf-8 -*-
from .qt_compat import BUTTONBOX_OK, QICON_NORMAL, QICON_OFF, SIZEPOLICY_EXPANDING, SIZEPOLICY_MAXIMUM
...
class Ui_dlgCreateRem(object):
    def setupUi(self, dlgCreateRem):
        ...
        self.groupBoxProfil.setGeometry(QtCore.QRect(10, 10, 401, 531))
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(False)
        font.setWeight(50)
        ...
        sizePolicy = QtWidgets.QSizePolicy(SIZEPOLICY_MAXIMUM, SIZEPOLICY_EXPANDING)
        ...
        self.lblMessageError.setGeometry(QtCore.QRect(10, 490, 391, 31))
        ...
        self.buttonBox.setGeometry(QtCore.QRect(170, 550, 101, 23))
        self.buttonBox.setStandardButtons(BUTTONBOX_OK)
