...
class Ui_SeeReportView(object):
    def setupUi(self, SeeReportView):
        ...
        self.lbl_displayResponses = QtWidgets.QLabel(SeeReportView)
        self.lbl_displayResponses.setGeometry(QtCore.QRect(10, 480, 631, 91))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.lbl_displayResponses.setFont(font)
        self.lbl_displayResponses.setText("")
        self.lbl_displayResponses.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.lbl_displayResponses.setWordWrap(True)
        self.lbl_displayResponses.setObjectName("lbl_displayResponses")
        ...
        self.lbl_displayThemes = QtWidgets.QLabel(SeeReportView)
        self.lbl_displayThemes.setGeometry(QtCore.QRect(380, 90, 261, 141))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.lbl_displayThemes.setFont(font)
        self.lbl_displayThemes.setText("")
        self.lbl_displayThemes.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.lbl_displayThemes.setWordWrap(True)
        self.lbl_displayThemes.setObjectName("lbl_displayThemes")
