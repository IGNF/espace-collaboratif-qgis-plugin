...
class Ui_DialogChargerGuichet(object):
    def setupUi(self, DialogChargerGuichet):
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=DialogChargerGuichet)
        ...
        self.labelMonGuichet = QtWidgets.QLabel(parent=DialogChargerGuichet)
        ...
        self.labelFondsGeoservices = QtWidgets.QLabel(parent=DialogChargerGuichet)
        ...
        self.tableWidgetMonGuichet = QtWidgets.QTableWidget(parent=DialogChargerGuichet)
        ...
        self.tableWidgetMonGuichet.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.tableWidgetMonGuichet.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustIgnored)
        self.tableWidgetMonGuichet.setAutoScroll(True)
        self.tableWidgetMonGuichet.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollMode.ScrollPerItem)
        self.tableWidgetMonGuichet.setShowGrid(False)
        self.tableWidgetMonGuichet.setGridStyle(QtCore.Qt.PenStyle.NoPen)
        ...
        self.tableWidgetFondsGeoservices = QtWidgets.QTableWidget(parent=DialogChargerGuichet)
        self.tableWidgetFondsGeoservices.setGeometry(QtCore.QRect(10, 400, 731, 261))
        self.tableWidgetFondsGeoservices.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.tableWidgetFondsGeoservices.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustIgnored)
        self.tableWidgetFondsGeoservices.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollMode.ScrollPerItem)
        self.tableWidgetFondsGeoservices.setShowGrid(False)
        self.tableWidgetFondsGeoservices.setGridStyle(QtCore.Qt.PenStyle.NoPen)
        ...
        self.labelGroupeActif = QtWidgets.QLabel(parent=DialogChargerGuichet)
        self.labelGroupeActif.setGeometry(QtCore.QRect(10, 10, 621, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.pushButton_checkAllBoxes_MonGuichet = QtWidgets.QPushButton(parent=DialogChargerGuichet)
        ...
        self.pushButton_checkAllBoxes_FondsGeoservices = QtWidgets.QPushButton(parent=DialogChargerGuichet)
    ...
    def retranslateUi(self, DialogChargerGuichet):
        ...
        self.pushButton_checkAllBoxes_MonGuichet.setText(_translate("DialogChargerGuichet", "Tout charger"))
        self.pushButton_checkAllBoxes_FondsGeoservices.setText(_translate("DialogChargerGuichet", "Tout charger"))
