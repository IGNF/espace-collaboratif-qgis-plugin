# -*- coding: utf-8 -*-
from .qt_compat import BUTTONBOX_CANCEL, ORIENTATION_HORIZONTAL, QICON_NORMAL, QICON_OFF
...
class Ui_addResponse(object):
    def setupUi(self, addResponse):
        ...
        self.btnCancel.setOrientation(ORIENTATION_HORIZONTAL)
        self.btnCancel.setStandardButtons(BUTTONBOX_CANCEL)
    ...
    def retranslateUi(self, addResponse):
        ...
        addResponse.setWindowTitle(_translate("addResponse", "Espace Collaboratif : Ajout d\'une nouvelle réponse"))
