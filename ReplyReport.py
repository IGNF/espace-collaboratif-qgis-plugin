...
class ReplyReport(object):
    ...
    def do(self) -> None:
        ...
        try:
            ...
            if dlgReplyReport.bResponse:
                ...
                self.__context.iface.messageBar().pushMessage("Succès", information, Qgis.Success, duration = 5)
    ...
    def __isLayerExist(self) -> bool:
        ...
        if not self.__context.IsLayerInMap(cst.nom_Calque_Signalement):
            ...
            self.__context.iface.messageBar().pushMessage("Attention", mess, Qgis.Warning, duration = 3)
